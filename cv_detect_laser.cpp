...
cv::Mat_<double> mean_hsv_laser(3,1);
cv::Mat_<double> cov_hsv_laser(3,3);
...
cv::Mat detect_laser(cv::Mat image)
{
...
int main( )
{
  ...
  initilize();
  //std::string video_url_str   = "laser.avi";
